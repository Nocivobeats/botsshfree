...
// Bot criado por @NocivoBeatsSshFree_bot código original para o @NocivoBeatsSshFree_bot
...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		...
		'reply_markup' => $tlg->buildInlineKeyBoard ([
			[$tlg->buildInlineKeyboardButton ('🇧🇷 CONTA GRATIS 🇧🇷', null, '/sshgratis')]
		])
	]);
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'Bot original @NocivoBeatsSshFree_bot por @NocivoBeats'
	]);
	...
	if ($redis->dbSize () == $limite){
		...
		$textoSSH="  CONTA CRIADA ;)\r\n\r\n<b>Servidor:</b> <code>".$ip."</code>\r\n<b>Usuario:</b> <code>".$usuario."</code>\r\n<b>Senha:</b> <code>".$senha."</code>\r\n<b>Logins:</b> 1\r\n<b>Validade:</b> ".date ('d/m', strtotime('+1 day'))."\r\r\n\r\nIP: 191.252.203.155\r\n\r\nPorta websocks security 8080\r\n\r\nPorta proxy socks 80\r\n\r\nPorta ssl 443\r\n\r\nOferecido por @NocivoBeats";
